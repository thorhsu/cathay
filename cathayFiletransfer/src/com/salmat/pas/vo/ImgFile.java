...
@NamedQueries({
	...
	@NamedQuery(name="ImgFile.findGroupImage", query="from ImgFile where image = true and fileNm like '/group/image/%'"),
	@NamedQuery(name="ImgFile.findGroupLaw", query="from ImgFile where law = true and fileNm like '/group/law/%'"),
	@NamedQuery(name="ImgFile.findNormImage", query="from ImgFile where image = true and fileNm like '/image/%'"),
	@NamedQuery(name="ImgFile.findNormLaw", query="from ImgFile where law = true and fileNm like '/law/%'"),
	@NamedQuery(name="ImgFile.findTestImage", query="from ImgFile where image = true and fileNm like '/test/image/%'"),
	@NamedQuery(name="ImgFile.findTestLaw", query="from ImgFile where law = true and fileNm like '/test/law/%'")
})
