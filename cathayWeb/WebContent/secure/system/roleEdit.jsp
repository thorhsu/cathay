		...
		<table width="825" border="0" align="center" cellpadding="0"
			...
			<tr>
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					class="outline">
					<tr>
						<td colspan="2" class="title">角色修改</td>
					</tr>
					<tr>
						<td colspan="2">
							<div id="divCriteria">
								<table width="100%" border="0" cellpadding="0" cellspacing="1"
									...
									<tr>
										<th>權限角色</th>
										<td>
										    <t:outputText value="#{authorityMaintainBean.adminPageUserRole.userRole}" />
											<t:inputHidden 
												id="userRole" 
												forceId="true" 
									...
									<tr>
										<th>只能查詢自己行政中心</th>										
										<td>
											<t:selectOneMenu id="centerId" forceId="true" value="#{authorityMaintainBean.adminPageUserRole.centerOnly}" >
                                                  <f:selectItem  itemLabel="是" itemValue="1" />
                                                  <f:selectItem  itemLabel="否" itemValue="2" />
                                              </t:selectOneMenu>
										</td>
					...
					<tr>
						<td colspan="4" align="center">
							...
							<t:commandButton 
								...
								action="#{authorityMaintainBean.edit}" />&nbsp;&nbsp;
							<t:commandButton 
								value="取消" 
								title="取消"
								id="btnCancel"
